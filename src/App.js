...
class App extends Component {
  ...
  onButtonSubmit = () => {
    this.setState({imageUrl: this.state.input, boxes: []}); // Reset boxes
    ...
    .then(response => {
      if (response) {
        ...
        // Calculate face locations for multiple faces
        const faceBoxes = this.calculateFaceLocations(response);
